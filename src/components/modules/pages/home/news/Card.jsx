...
export default function (props) {
  return (
    <div className="rounded-xl bg-neutral-100 p-8 dark:bg-neutral-800">
      ...
      />
      <div className="mt-8 flex flex-col justify-between space-y-2 text-left">
        <p className="text-yellow-500">{props.topic}</p>
        <p className="text-lg font-medium">{props.title}</p>
        <p className="text-sky-600 dark:text-neutral-300">{props.desc}</p>
        <Link
          to={props.news}
