        ...
        <div class="rounded-xl bg-neutral-100 p-8 dark:bg-neutral-800">
          ...
          <div class="space-y-8 text-left">
            ...
            <div class="font-medium">
              <div class="text-yellow-500">Timothy Joseph, Dog food taster</div>
              <div class="text-neutral-7000">SDH Daan Mogot, Class of 1789</div>
            </div>
          </div>
        </div>
        <div class="rounded-xl bg-neutral-100 p-8 dark:bg-neutral-800">
          ...
          <div class="space-y-8 text-left">
            ...
            <div class="font-medium">
              <div class="text-yellow-500">Alexa Tan, Professional sleeper</div>
              <div class="text-neutral-7000">SDH Daan Mogot, Class of 1862</div>
            </div>
          </div>
        </div>
        <div class="rounded-xl bg-neutral-100 p-8 dark:bg-neutral-800">
          ...
          <div class="space-y-8 text-left">
            ...
            <div class="font-medium">
              ...
              <div class="text-neutral-7000">SDH Daan Mogot, Class of 1959</div>
            </div>
          </div>
        </div>
      </div>
